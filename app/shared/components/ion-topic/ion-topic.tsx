        ...
        return (
            <Card
              ...
              ">
                ...
                <CardFooter>
                    <Link href={`/topics/${slug}`} className="
                    hover:text-[#FF66C4]
                    ">
                        Ver conteúdo
                    </Link>
...
) as React.ForwardRefExoticComponent<TopicProps & React.RefAttributes<HTMLDivElement>>;
...
) as React.ForwardRefExoticComponent<TopicsProps & React.RefAttributes<HTMLDivElement>>;
